...
class KanbanSettingTab extends PluginSettingTab {
  ...
  private emptyFieldResetters: Array<() => Promise<void>> = [];
  ...
  private bindDefaultOnEmpty(
    text: TextComponent,
    defaultValue: string,
    applySync: (value: string) => void,
    ...
    text.inputEl.addEventListener("blur", () => { void resetIfEmpty(); });
  ...
  async display(): Promise<void> {
    ...
    new Setting(containerEl)
      ...
      .addText((text) => {
        const applyKanban = (value: string) => {
    ...
    typeGroup((box) => {
      new Setting(box)
        ...
        .addText((text) => {
          const applyDoneColumn = (value: string) => { this.plugin.settings.doneColumn = value.trim(); };
          text
            .setPlaceholder("#done")
    ...
    typeGroup((box) => {
      new Setting(box)
        ...
        .addText((text) => {
          const applyStartColumn = (value: string) => { this.plugin.settings.startColumn = value.trim(); };
          text
    ...
    typeGroup((box) => {
      new Setting(box)
        ...
        .addText((text) => {
          const applyDueColumn = (value: string) => { this.plugin.settings.dueColumn = value.trim(); };
          text
            .setPlaceholder("#due")
    ...
    typeGroup((box) => {
      new Setting(box)
        ...
        .addText((text) => {
          const applyLaterColumn = (value: string) => { this.plugin.settings.laterColumn = value.trim(); };
          text
    ...
    typeGroup((box) => {
      new Setting(box)
        ...
        .addText((text) => {
          const applyRecurrentColumn = (value: string) => { this.plugin.settings.recurrentColumn = value.trim(); };
          text
    ...
    new Setting(containerEl)
      ...
      .addText((text) => {
        const applyNewTaskInsert = (value: string) => { this.plugin.settings.newTaskInsert = value.trim(); };
        text
